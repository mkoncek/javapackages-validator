 ...
 * times. This class delegates result operations to another {@link Result}
 * instance.
 */
class NamedResult implements Result {
    ...
    /**
     * Constructs a {@link NamedResult} with a delegate result, test name, start
     * time, and end time.
     * 
     * @param delegate  the delegate {@link Result} instance
     * @param testName  the name of the test
     * @param startTime the start time of the test execution, or {@code null} if not
     *                  available
     * @param endTime   the end time of the test execution, or {@code null} if not
     *                  available
     */
    ...
    /**
     * Constructs a {@code NamedResult} with a delegate result and test name,
     * without specifying start and end times.
     * 
     * @param delegate the delegate {@code Result} instance
     * @param testName the name of the test
     */
     ...
     * 
     * @return an iterator over {@code LogEntry} objects
     */
    @Override
     ...
     * 
     * @return the {@code TestResult} of the delegate
     */
    @Override
     ...
     * 
     * @return the start time, or {@code null} if not set
     */
     ...
     * 
     * @return the end time, or {@code null} if not set
     */
    Instant getEndTime() {
        return endTime;
    }
